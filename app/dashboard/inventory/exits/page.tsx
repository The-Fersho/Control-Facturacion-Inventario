...
export default function ExitsPage() {
  ...
  const loadData = () => {
    ...
    setMovements(allMovements.filter((m) => m.type === "salida"))
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (!product || product.stock < Number.parseFloat(formData.quantity)) {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold">Salidas de Inventario</h1>
          <p className="text-muted-foreground mt-1">Registra las salidas de productos</p>
        </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  placeholder="Ej: Merma, Daño, Ajuste, etc."
                  required
                />
              </div>
